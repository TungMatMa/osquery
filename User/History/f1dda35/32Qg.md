...
* Linux: **/var/lancs-agent/etc/lc/lc.conf** and **/var/lancs-agent/etc/lc/lc.conf.d/**
* macOS: **/var/osquery/osquery.conf** and **/var/osquery/osquery.conf.d/**

You may override the **filesystem** plugin's path using
`--config_path=/path/to/lc.conf`. You may also use the ".d/" directory
...
cookbook_file '/var/lancs-agent/etc/lc/lc.conf' do
  source 'lc.conf'
  mode 0444
  owner 'root'
  group 'wheel'
