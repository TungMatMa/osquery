...
TEST_F(KafkaProducerPluginTest, getMsgName_tests) {
  ...
  std::map<std::string, std::string> tests = {
      ...
      {"{\"diffResults\":{\"removed\":[{\"cmdline\":\"\",\"on_disk\":\"-1\","
       ...
       "\"I\",\"uid\""
       ":\"0\"},{\"cmdline\":\"lcd --verbose --flagfile "
       "/etc/osquery/osquery.kafka."
       "flags\",\"on_disk\":\"1\",\"path\":\"/usr/local/bin/"
       "lcd\",\"pid\":\"8483\","
       "\"state\":\"S\",\"uid\":\"0\"},{\"cmdline\":\"sudo lcd --verbose "
       "--flagfil"
       "e "
      ...
      {"{\"diffResults\":{\"removed\":[{\"cmdline\":\"\",\"on_disk\":\"-1\","
       ...
       "usr/local/bin/"
       "lcd\",\"pid\":\"8483\",\"name\":\"lcd\",\"state\":\"S\","
       "\"uid\":\"0\"},{\"cmdline\":\"sudo lcd --verbose --flagfile "
       "/etc/osquery/os"
       "query.kafka.flags\",\"on_disk\":\"1\",\"path\":\"/usr/bin/"
       "sudo\",\"pid\":\"8482\""
       ",\"name\":\"lcd\",\"state\":\"S\",\"uid\":\"0\"}],\"added\":[{"
       "\"cmdline\":"
       ...
       "\"I\",\"uid\""
       ":\"0\"},{\"cmdline\":\"sudo lcd --verbose --flagfile "
       "/etc/osquery/osquery."
       "filesystem.flags\",\"on_disk\":\"1\",\"path\":\"/usr/bin/"
       "sudo\",\"pid\":\"15821\""
       ",\"name\":\"lcd\",\"state\":\"S\",\"uid\":\"0\"},{\"cmdline\":"
       "\"lcd -"
       "-verbose --flagfile "
       "/etc/osquery/osquery.filesystem.flags\",\"on_disk\":\"1\",\""
       "path\":\"/usr/local/bin/"
       "lcd\",\"pid\":\"15822\",\"name\":\"lcd\",\"sta"
